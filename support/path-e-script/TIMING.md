...
|---|---:|---:|---:|---:|
| Modular script pack | checklist, operator protocol, Modules 0-21, and weekly rollout plan; excludes this timing guide | 18,851 | ~2.6 hours | ~15-23 hours |
| Minimum full Path E | `support/path-e-script-minimum/scripts/*.md` | 77,769 | ~10.8 hours | ~30-50 hours |
| Medium full Path E | `support/path-e-script-medium/scripts/*.md` | 217,669 | ~30.2 hours | ~75-120 hours |
| Verbose maximal Path E | `support/path-e-script-verbose/scripts/*.md` | 298,037 | ~41.4 hours | ~105-165 hours |
