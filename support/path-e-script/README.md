...
- [`../path-e-script-minimum/README.md`](../path-e-script-minimum/README.md) — 79,176-word tier, split under `scripts/`.
- [`../path-e-script-medium/README.md`](../path-e-script-medium/README.md) — 219,591-word tier, split under `scripts/`.
- [`../path-e-script-verbose/README.md`](../path-e-script-verbose/README.md) — 299,959-word tier, split under `scripts/`.
