...
- [`../path-e-script-minimum/README.md`](../path-e-script-minimum/README.md) — 79,718-word tier, split under `scripts/`.
- [`../path-e-script-medium/README.md`](../path-e-script-medium/README.md) — 220,133-word tier, split under `scripts/`.
- [`../path-e-script-verbose/README.md`](../path-e-script-verbose/README.md) — 300,501-word tier, split under `scripts/`.
