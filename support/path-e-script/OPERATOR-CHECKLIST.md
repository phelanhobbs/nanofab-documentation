...
| You need the smallest generated full Path E that still meets the requested long-form floor. | `support/path-e-script-minimum/scripts/` | 79,718 words |
| You need a much deeper generated version, but still below the 250k ceiling. | `support/path-e-script-medium/scripts/` | 220,133 words |
| You have no time limit and want the maximal generated handoff. | `support/path-e-script-verbose/scripts/` | 300,501 words |
