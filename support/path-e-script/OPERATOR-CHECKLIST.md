...
|---|---|---:|
| You need a practical live handoff script with one file per module. | `support/path-e-script/` | 17,108 words |
| You need the smallest generated full Path E that still meets the requested long-form floor. | `support/path-e-script-minimum/scripts/` | 88,794 words |
| You need a much deeper generated version, but still below the 250k ceiling. | `support/path-e-script-medium/scripts/` | 229,239 words |
| You have no time limit and want the maximal generated handoff. | `support/path-e-script-verbose/scripts/` | 314,105 words |
