...
for f in START-HERE.md support/PRESENTATION-GUIDE.md support/path-e-script/README.md support/path-e-script-minimum/README.md support/path-e-script-medium/README.md support/path-e-script-verbose/README.md support/EVALUATE.md support/REDACTION-NOTE.md support/audit.sh; do
  if [ -f "$f" ]; then
