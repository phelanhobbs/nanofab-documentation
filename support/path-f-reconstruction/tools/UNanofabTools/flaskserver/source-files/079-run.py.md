...
- Sanitized SHA-256 prefix: `ab6ff8f7d9d34c2e`
...
# Default to production so a missing/misnamed FLASK_ENV can't silently fall back
# to DevelopmentConfig (which skips Duo 2FA and drops Secure cookies). Local
# development must opt in explicitly with FLASK_ENV=development.
