# Verbose Maximal Path E - Module 15: Pico And Particle
...
## Source-code pass for Module 15

READ ALOUD:

We are now doing the source-code pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Live-state pass for Module 15

READ ALOUD:

We are now doing the live-state pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Failure-mode pass for Module 15

READ ALOUD:

We are now doing the failure-mode pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Maintenance-planning pass for Module 15

READ ALOUD:

We are now doing the maintenance-planning pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Security pass for Module 15

READ ALOUD:

We are now doing the security pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Recovery pass for Module 15

READ ALOUD:

We are now doing the recovery pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Documentation-drift pass for Module 15

READ ALOUD:

We are now doing the documentation-drift pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Teach-back pass for Module 15

READ ALOUD:

We are now doing the teach-back pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Homework-review pass for Module 15

READ ALOUD:

We are now doing the homework-review pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Quarterly-audit pass for Module 15

READ ALOUD:

We are now doing the quarterly-audit pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Backup-and-restore pass for Module 15

READ ALOUD:

We are now doing the backup-and-restore pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Ownership-boundary pass for Module 15

READ ALOUD:

We are now doing the ownership-boundary pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## No-contact rehearsal pass for Module 15

READ ALOUD:

We are now doing the no-contact rehearsal pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Operator-error pass for Module 15

READ ALOUD:

We are now doing the operator-error pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Data-integrity pass for Module 15

READ ALOUD:

We are now doing the data-integrity pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
## Final-repetition pass for Module 15

READ ALOUD:

We are now doing the final-repetition pass for Pico And Particle. The maintainer should connect this module to canonical NanofabToolkit firmware/viewer source and sensor identity. Do not accept a vague answer. Require a named file, named command, named source path, or named live-state observation wherever possible.
...
# Read-Aloud Documentation Corpus: documentation/UNanofabTools/particlepctools/README.md
...
# Read-Aloud Documentation Corpus: documentation/UNanofabTools/picofirmware/README.md
...
# Read-Aloud Documentation Corpus: known-issues/NanofabToolkit/ParticleSensor.md
...
# Read-Aloud Documentation Corpus: known-issues/NanofabToolkit/PicoHelperTools.md
...
# Read-Aloud Documentation Corpus: presentation/NanofabToolkit/ParticleSensor/README.md
...
# Read-Aloud Documentation Corpus: presentation/NanofabToolkit/PicoHelperTools/README.md
...
# Read-Aloud Documentation Corpus: presentation/UNanofabTools/particlepctools/README.md
...
# Read-Aloud Documentation Corpus: presentation/UNanofabTools/picofirmware/README.md
...
## Slide Notes From presentation/NanofabToolkit/ParticleSensor/slides/_build/build_tool.js
...
## Slide Notes From presentation/NanofabToolkit/ParticleSensor/slides/_build/deckkit.js
...
## Slide Notes From presentation/NanofabToolkit/ParticleSensor/slides/_build/meta.js
...
## Slide Notes From presentation/NanofabToolkit/ParticleSensor/slides/_build/tooldecks/particlesensor.js

READ ALOUD OR USE AS SPEAKER NOTES:

- ); module.exports = { filename:
- , build(d) { d.title_slide({ kicker:
- The desktop dashboard for the cleanroom's particle sensors. A plain-English walkthrough.
...
- How the room boxes are color-coded
- A glance at the map tells you which rooms are reporting and roughly how clean they are:
- yellow → no data yet
...
- The map is a status board, not just a layout — colors carry the news.
...
- , steps: [ { h:
- the map appears with rooms in yellow.
- rooms turn green or red as data arrives.
- every sensor's latest reading is listed.
- a history window opens with that sensor's chart.
...
- A quirk worth knowing (the +7h offset)
...
## Slide Notes From presentation/NanofabToolkit/PicoHelperTools/slides/_build/build_tool.js
...
## Slide Notes From presentation/NanofabToolkit/PicoHelperTools/slides/_build/deckkit.js
...
## Slide Notes From presentation/NanofabToolkit/PicoHelperTools/slides/_build/meta.js
...
## Slide Notes From presentation/NanofabToolkit/PicoHelperTools/slides/_build/tooldecks/picohelpertools.js

READ ALOUD OR USE AS SPEAKER NOTES:

- ); module.exports = { filename:
- , build(d) { d.title_slide({ kicker:
- The small Pico programs that feed the cleanroom's sensor data. A plain-English walkthrough.
...
- Both sensors on one Pico
- ], ], colW: [3.8, 4.5, 3.6], notes:
...
- The rhythm every Pico follows
- join the lab's ULink network at boot.
- ask an internet time server so timestamps are right.
- every 15 seconds during a measurement window.
- Wait for the next scheduled minute
- :00, :15, :30, or :45 by default.
- post a JSON message over the encrypted connection.
- a watchdog timer resets the board if something hangs.
...
- What a particle reading looks like on the wire
- An SPS30 reading wrapped up as JSON before sending:
- : 1734567890.0, ' + '
- : 4.1, ... }, ' + '
- Identity, time, and the measurements — exactly what the server expects.
...
- Per-board identity (and the gotcha)
...
- Things on the maintenance list
...
## Slide Notes From presentation/UNanofabTools/particlepctools/slides/_build/build_tool.js
...
## Slide Notes From presentation/UNanofabTools/particlepctools/slides/_build/deckkit.js
...
## Slide Notes From presentation/UNanofabTools/particlepctools/slides/_build/meta.js
...
## Slide Notes From presentation/UNanofabTools/particlepctools/slides/_build/tooldecks/particlepctools.js

READ ALOUD OR USE AS SPEAKER NOTES:

- ); module.exports = { filename:
- , build(d) { d.title_slide({ kicker:
- The desktop viewer and the test-data generator. A plain-English walkthrough.
...
- What the generator pretends to be
- A few of its built-in synthetic sensors:
- Each pretend sensor has a realistic baseline and natural variation.
...
## Slide Notes From presentation/UNanofabTools/picofirmware/slides/_build/build_tool.js
...
## Slide Notes From presentation/UNanofabTools/picofirmware/slides/_build/deckkit.js
...
## Slide Notes From presentation/UNanofabTools/picofirmware/slides/_build/meta.js
...
## Slide Notes From presentation/UNanofabTools/picofirmware/slides/_build/tooldecks/picofirmware.js

READ ALOUD OR USE AS SPEAKER NOTES:

- ); module.exports = { filename:
- , build(d) { d.title_slide({ kicker:
- The little programs on the Raspberry Pi sensors that feed the server. A plain-English walkthrough.
...
- The rhythm every Pico follows
- join the lab's ULink network.
- particles, a gauge voltage, or a value over a cable.
- wrap the numbers with room, sensor, and timestamp.
- post to the matching sensor address.
- sleep an interval, then do it again — forever.
...
- Particle_sensor.py — the reference one
- The most complete firmware; the template for new sensors.
...
- A particle reading, packaged as structured data:
- , ' + ' sensor_number:
- , ' + ' timestamp: <now>, ' + ' raw_measurements: { mass_pm2_5, ... }, ' + ' converted_values: { number_concentrations_ft3, ... } ' + ' } → POST /particle-data', caption:
...
- PicoDenton18.py — the evaporator (unfinished)
